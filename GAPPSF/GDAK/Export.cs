...
namespace GAPPSF.GDAK
{
    public class Export
    {
        ...
        private string getWPType(Core.Data.WaypointType type)
        {
            switch (type.ID)
            {
        ...
        private string getContainer(Core.Data.GeocacheContainer container)
        {
            switch (container.ID)
            {
        ...
        private string getCacheType(Core.Data.GeocacheType type)
        {
            switch (type.ID)
            {
                case 2: return "T";
