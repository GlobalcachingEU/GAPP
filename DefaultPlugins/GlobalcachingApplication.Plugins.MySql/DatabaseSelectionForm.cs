...
namespace GlobalcachingApplication.Plugins.MySql
{
    public partial class DatabaseSelectionForm : Form
    {
        ...
        public const string STR_TITLE = "MySql database";
        ...
        public const string STR_DEFAULTPORT = "Leave empty for default port 3306";
        ...
        public DatabaseSelectionForm()
        {
            ...
            this.label10.Text = Utils.LanguageSupport.Instance.GetTranslation(STR_PORT);
            this.label11.Text = Utils.LanguageSupport.Instance.GetTranslation(STR_DEFAULTPORT);
            ...
            textBox5.Text = Properties.Settings.Default.SqlServerPort;
