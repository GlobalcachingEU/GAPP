...
namespace GlobalcachingApplication.Plugins.SHP
{
    public class ShapeFile: IDisposable
    {
        ...
        private List<Framework.Data.AreaInfo> _areaInfos = new List<Framework.Data.AreaInfo>();
        ...
        public List<Framework.Data.AreaInfo> AreaInfos
        {
        ...
        private void GetPolygonOfArea_PolygonM(List<Framework.Data.Polygon> polygons, IndexRecord rec)
        {
