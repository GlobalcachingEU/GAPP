...
{
    public class ExportAddOnGSAKDatabase : Utils.BasePlugin.BaseExportFilter
    {
        public const string STR_NOGEOCACHESELECTED = "No geocache selected for export";
        public const string STR_ERROR = "Error";
        public const string STR_EXPORTINGGPX = "Exporting Locus - addon GSAK Database...";
        ...
        public const string ACTION_EXPORT_ALL = "Export Locus - addon GSAK Database|All";
        public const string ACTION_EXPORT_SELECTED = "Export Locus - addon GSAK Database|Selected";
