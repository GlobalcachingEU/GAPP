...
namespace GlobalcachingApplication.Utils
{
    public class GPXGenerator
    {
        ...
        private Framework.Data.Geocache _activeGcg = null;
        private Version _gpxVersion;
        private int _index;
        private int _maxLogCount = 5;
        private bool _addFieldnotesToDescription = false;
        private int _maxNameLength = 255;
        private int _minStartOfname = 255;
        private bool _useNameForGCCode = false;
        ...
        public bool UseHintsForDescription
        {
            ...
            set { _useHintsForDescription = value; }
        }
        public bool AddAdditionWaypointsToDescription
        {
            get { return _addAdditionWaypointsToDescription; }
            set { _addAdditionWaypointsToDescription = value; }
        }
        public bool AddFieldnotesToDescription
        {
            get { return _addFieldnotesToDescription; }
            set { _addFieldnotesToDescription = value; }
        }
        ...
        public int MinStartOfname
        {
            get { return _minStartOfname; }
            set { _minStartOfname = value; }
        }

        public bool UseNameForGCCode
        {
            get { return _useNameForGCCode; }
            set { _useNameForGCCode = value; }
        }

        public string ExtraCoordPrefix
        {
            get { return _extraCoordPrefix; }
            set { _extraCoordPrefix = value; }
        }
        ...
        private string transformedGeocacheName(string orgName)
        {
            ...
            else if (orgName.Length <= _maxNameLength)
            {
                return orgName;
            }
            else if (_maxNameLength <= _minStartOfname)
            {
                return orgName.Substring(0, _maxNameLength);
            }
            else
            {
                return string.Format("{0}.{1}", orgName.Substring(0, _minStartOfname), orgName.Substring(orgName.Length - (_maxNameLength - _minStartOfname) - 1));
            }
        }
