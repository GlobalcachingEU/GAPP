...
namespace GlobalcachingApplication.Utils
{
    public class Calculus
    {
        ...
        public static GeodeticMeasurement CalculateDistance(Framework.Data.Geocache gc, Framework.Data.Location loc)
        {
        ...
        public static bool PointInPolygon(List<Framework.Data.Location> points, Framework.Data.Location ll)
        {
            return PointInPolygon(points, ll.Lat, ll.Lon);
        }
        public static bool PointInPolygon(List<Framework.Data.Location> points, double lat, double lon)
        {
            bool result = false;
        ...
        public static Framework.Data.CompassDirection GetCompassDirectionFromAngle(int angle)
        {
            ...
            if (deg >= (360 - 22.5) || deg <= 22.5) result = Framework.Data.CompassDirection.N;
            else if (deg >= (45 - 22.5) && deg <= (45 + 22.5)) result = Framework.Data.CompassDirection.NE;
            else if (deg >= (90 - 22.5) && deg <= (90 + 22.5)) result = Framework.Data.CompassDirection.E;
            else if (deg >= (135 - 22.5) && deg <= (135 + 22.5)) result = Framework.Data.CompassDirection.SE;
            else if (deg >= (180 - 22.5) && deg <= (180 + 22.5)) result = Framework.Data.CompassDirection.S;
            else if (deg >= (225 - 22.5) && deg <= (225 + 22.5)) result = Framework.Data.CompassDirection.SW;
            else if (deg >= (270 - 22.5) && deg <= (270 + 22.5)) result = Framework.Data.CompassDirection.W;
            else if (deg >= (315 - 22.5) && deg <= (315 + 22.5)) result = Framework.Data.CompassDirection.NW;
            return result;
        }
