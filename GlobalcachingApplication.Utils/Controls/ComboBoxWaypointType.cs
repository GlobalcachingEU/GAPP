...
{
    public class ComboBoxWaypointType: ComboBox
    {
        private List<Image> _images = null;
        private  StringFormat _fs = null;
        public ComboBoxWaypointType()
        {
            ...
            this.DrawItem += new DrawItemEventHandler(ComboBoxWaypointType_DrawItem);
            ItemHeight = 20;
        }
        ...
        public void SetWaypointTypes(Framework.Interfaces.ICore core, List<Framework.Data.WaypointType> lt)
        {
            BeginUpdate();
            ClearImages();
        ...
        void ComboBoxWaypointType_DrawItem(object sender, DrawItemEventArgs e)
        {
