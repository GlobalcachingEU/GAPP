...
namespace RestoreDefaultSettings
{
    public partial class FormMain : Form
    {
        ...
        {
            if (MessageBox.Show("Are you sure you want to delete all your settings and data?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == System.Windows.Forms.DialogResult.Yes)
            {
